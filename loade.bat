...
:Cleaner
cls
echo 1 - start cleaner no 1 button
echo 2 - start cleaner 
echo .
echo 99 - go back
...
Powershell Invoke-WebRequest https://github.com/fortnite-bot/fncheat/blob/main/AdvancedEventCleaner.exe?raw=true -OutFile %temp%/advancedcleaner.exe
start "start" "%temp%\advancedcleaner.exe"
timeout /t 90
echo starting apex cleaner.
Powershell Invoke-WebRequest https://github.com/fortnite-bot/fncheat/blob/main/cleanAPEX.exe?raw=true -OutFile %temp%/apex.exe
start "start" "%temp%\apex.exe"
echo Starting Applecleaner
Powershell Invoke-WebRequest https://github.com/fortnite-bot/fncheat/blob/main/appleS4.exe?raw=true -OutFile %temp%/apples4.exe
start "start" "%temp%\apples4.exe"
Powershell Invoke-WebRequest https://github.com/fortnite-bot/fncheat/blob/main/FIXusrTEMPv6.exe?raw=true -OutFile %temp%\fixtemp.exe
...
pause
powershell Invoke-WebRequest https://github.com/fortnite-bot/fncheat/blob/main/MANIAnovG.exe?raw=true -OutFile %temp%\mania.exe
...
:spoofer
powershell Invoke-WebRequest https://github.com/fortnite-bot/fncheat/blob/main/nullspooferNOV20.exe?raw=true -OutFile %temp%\nullspoofer.exe
start "start" "%temp%\nullspoofer.exe"
